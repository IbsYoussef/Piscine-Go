...
echo "Testing recursivefactorial..."
echo ""
...
sed '/^package student/d' student/recursivefactorial.go >> temp_student.go
...
func main() {
	...
	fmt.Println(RecursiveFactorial(1))
	fmt.Println(RecursiveFactorial(5))
	fmt.Println(RecursiveFactorial(-5))
	fmt.Println(RecursiveFactorial(20))
	fmt.Println(RecursiveFactorial(21))
}
EOF
...
sed '/^package solutions/d' solutions/recursivefactorial.go >> temp_solution.go
