...
sed '/^package student/d' student/iterativepower.go >> temp_student.go
...
func main() {
	...
	fmt.Println(IterativePower(5, 0))
	fmt.Println(IterativePower(3, -2))
	fmt.Println(IterativePower(10, 1))
}
EOF
...
sed '/^package solutions/d' solutions/iterativepower.go >> temp_solution.go
