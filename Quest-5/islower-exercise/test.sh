...
sed '/^package student/d' student/islower.go >> temp_student.go
...
func main() {
	...
	fmt.Println(IsLower("hello!"))
	fmt.Println(IsLower("Hello"))
	fmt.Println(IsLower("abc123"))
	fmt.Println(IsLower(""))
	fmt.Println(IsLower("a"))
...
sed '/^package solutions/d' solutions/islower.go >> temp_solution.go
