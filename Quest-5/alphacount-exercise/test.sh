...
sed '/^package student/d' student/alphacount.go >> temp_student.go

cat >> temp_student.go << 'EOF'

func main() {
	fmt.Println(AlphaCount("Hello 78 World!    4455 /"))
	fmt.Println(AlphaCount("abc123"))
	fmt.Println(AlphaCount("123!@#"))
	fmt.Println(AlphaCount(""))
	fmt.Println(AlphaCount("GoLang"))
	fmt.Println(AlphaCount("Test123Test"))
}
EOF
...
sed '/^package solutions/d' solutions/alphacount.go >> temp_solution.go
