...
sed '/^package student/d' student/strlen.go >> temp_student.go
...
func main() {
	...
	fmt.Println(StrLen("This is a longer string to test"))
}
EOF
...
sed '/^package solutions/d' solutions/strlen.go >> temp_solution.go
