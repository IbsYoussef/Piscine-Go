...
sed '/^package student/d' student/basicatoi2.go >> temp_student.go
...
func main() {
	...
	fmt.Println(BasicAtoi2("123abc"))
	fmt.Println(BasicAtoi2("999"))
}
EOF
...
sed '/^package solutions/d' solutions/basicatoi2.go >> temp_solution.go
