...
sed '/^package student/d' student/basicatoi.go >> temp_student.go
...
func main() {
	...
	fmt.Println(BasicAtoi("1"))
	fmt.Println(BasicAtoi("987654321"))
}
EOF
...
sed '/^package solutions/d' solutions/basicatoi.go >> temp_solution.go
