...
sed '/^package student/d' student/splitwhitespaces.go >> temp_student.go
...
sed '/^package solutions/d' solutions/splitwhitespaces.go >> temp_solution.go
